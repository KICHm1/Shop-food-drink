...
const Index = (props: Props) => {
  return (
    <motion.li
      ...
      className={`cursor-pointer lg:flex-col lg:h-[auto] h-[150px] group flex gap-[10px] justify-between  bg-[#c9c9c94d] hover:bg-[#f95555]  hover:scale-105 hover:z-[2] border-[#f95555] rounded-[20px] relative ${props.width} w-[100%] transition-[transform,background] duration-[1s] z-[1]`}
    >
      <div
